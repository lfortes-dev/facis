# Contributing to FACIS - DCS project

Welcome to the FACIS - DCS open source project! It’s people like you that make it a reality for users in our community.
...
- To report security vulnerabilities, please send a mail to xfsc-dev@eclipse.org which is monitored by our security team.
...
- If you've never contributed before, see [Onboarding Contributers](https://eclipse-xfsc.github.io/landingpage/developer-guide/on-boarding/) for resources and tips on how to get started.
...
Join us in the [XFCS Community](https://projects.eclipse.org/projects/technology.xfsc) and post your question there in the correct category with a descriptive tag.